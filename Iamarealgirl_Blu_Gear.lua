function user_job_setup() 
	...
	state.Weapons:options('Naegmace','Almace','MeleeClubs','HybridWeapons','Naegbron','Tizbron','Tizalmace','None')
...
function init_gear_sets()
	...
	sets.HPCure = {main="Bunzi's Rod",sub="Nibiru Cudgel",ammo="Pemphredo Tathlum",
		...
		back="Moonlight Cape",waist="Carrier's Sash",legs="Carmine Cuisses",feet="Medium's Sabots"}
	...
	sets.precast.Step = {ammo="Falcon Eye",
					...
					back=gear.da_jse_back,waist="Olseni Belt",legs="Carmine Cuisses",feet="Malignance Boots"}
	...
	sets.precast.WS.Acc = {ammo="Falcon Eye",
			      ...
			      back=gear.da_jse_back,waist="Fotia Belt",legs="Carmine Cuisses",feet=gear.herculean_ta_feet}
	...
	sets.midcast['Blue Magic'].Magical.SIRD = {main="Bunzi's Rod",sub="Sakpata's Sword",ammo="Staunch Tathlum +1",
		 ...
		 back=gear.nuke_jse_back,waist="Emphatikos Rope",legs="Carmine Cuisses",feet="Amalric Nails +1"}
	...
	sets.midcast['Phalanx'] = set_combine(sets.midcast['Enhancing Magic'],{main="Pukulatmuj +1",sub="Sakpata's Sword",head="Carmine Mask +1",ear2="Mimir Earring",body=gear.taeon_phalanx_body,hands=gear.herculean_phalanx_hands,legs="Carmine Cuisses",feet=gear.herculean_nuke_feet})
	...
	sets.midcast['Blue Magic'].SkillBasedBuff = {main="Iris",sub="Iris",ammo="Mavi Tathlum",
		head="Luh. Keffiyeh +2",neck="Mirage Stole +2",ear1="Gifted Earring",ear2="Njordr Earring",
	...
	sets.idle.lowmp = {main="Bolelabunga",sub="Genmei Shield",ammo="Staunch Tathlum +1",
			      head="Amalric Coif +1", neck="Loricate Torque +1",ear1="Etiolation Earring", ear2="Ethereal Earring",
			      body="Jhakri Robe +2",hands=gear.herculean_refresh_hands,ring1="Stikini Ring +1",ring2="Stikini Ring +1",
			      back="Umbra Cape",waist="Flume Belt +1",legs="Lengo Pants",feet=gear.herculean_refresh_feet}
	...
	sets.idle.DTHippo = set_combine(sets.idle.PDT, {legs="Carmine Cuisses",feet="Hippo. Socks +1"})
	...
	sets.DWMax = {ear1="Dudgeon Earring",ear2="Heartseeker Earring",body="Adhemar Jacket +1",waist="Reiki Yotai",legs="Carmine Cuisses"}
	...
	sets.engaged = {ammo="Ginsen", head={ name="Adhemar Bonnet +1", augments={'AGI+12','Rng.Acc.+20','Rng.Atk.+20',}},
		...
		legs="Jhakri Slops +2",	feet={ name="Herculean Boots", augments={'Weapon skill damage +5%','Attack+3',}},
		neck="Asperity Necklace", waist="Reiki Yotai", left_ear="Telos Earring", right_ear="Ethereal Earring",
		left_ring="Petrov Ring", right_ring="Ilabrat Ring", back="Atheling Mantle",}
	...
	sets.engaged.Acc = {main="Tizona",sub="Almace",ammo="Falcon Eye",
				...
				back=gear.da_jse_back,waist="Windbuffet Belt +1",legs="Carmine Cuisses",feet="Malignance Boots"}
...
function select_default_macro_book()
	...
	if player.sub_job == 'DNC' then
		set_macro_page(2, 16)
		windower.send_command('gs l iamarealgirl_Blu_Dnc.lua')
		windower.send_command('wait 3; azureSets set dps')		
	elseif player.sub_job == 'NIN' then
		set_macro_page(3, 16)
		windower.send_command('gs l iamarealgirl_Blu_Nin.lua')
		windower.send_command('wait 3; azureSets set dps')		
	elseif player.sub_job == 'WAR' then
		set_macro_page(1, 16)
		windower.send_command('wait 3; gs l Blu_War.lua')
		windower.send_command('wait 3; azureSets set dps')		
