...
function user_setup()
    state.OffenseMode:options('DW', 'Normal', 'Ranged', 'Acc')
...
function init_gear_sets()
    ...
    sets.engaged.Melee = {ammo=gear.RAbullet,
		...
		body="Iuitl Vest",hands="Iuitl Wristbands",ring1="diamond ring",ring2="Epona's Ring",
    ...
    sets.engaged.Melee.DW = {main="tauret", sub="eletta sword", ammo=gear.RAbullet,
        head="mummu bonnet +1",neck="Asperity Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="mummu jacket +1",hands="mummu wrists +1",ring1="petrov Ring",ring2="Epona's Ring",
        back="bleating Mantle",waist="cetl Belt",legs="meghanada chausses +1",feet="mummu gamashes"}
    
    sets.engaged.Ranged = {ammo=gear.RAbullet,
        head="Whirlpool Mask",neck="combatant's torque",ear1="Clearview Earring",ear2="Volley Earring",
        body="Iuitl Vest",hands="Iuitl Wristbands",ring1="Defending Ring",ring2=gear.DarkRing.physical,
        back="Shadow Mantle",waist="Flume Belt",legs="Nahtirah Trousers",feet="Iuitl Gaiters +1"}
end
