...
send_command('bind ^!w gs c toggle AutoWSMode') --Turns auto-ws mode on and off.
send_command('bind ^w gs c cycle Weapons') --Cycle through weapons sets.
send_command('bind !w gs c weapons Default') --Requips weapons and gear.
send_command('bind f7 gs c cycle OffenseMode') --Changes offense settings such as accuracy.
send_command('bind ^f7 gs c cycle HybridMode') --Changes defense settings for melee such as PDT.
send_command('bind !f7 gs c cycle RangedMode') --Changes ranged offense settings such as accuracy.
send_command('bind ^!f8 gs c reset DefenseMode') --Turns your defensive mode off.
send_command('bind f8 gs c set DefenseMode Physical') --Turns your physical defense set on.
send_command('bind !f8 gs c set DefenseMode Resist') --Turns your resist defense set on.
send_command('bind ^f8 gs c cycle PhysicalDefenseMode') --Changes your physical defense set.
send_command('bind f9 gs c set DefenseMode Magical') --Turns your magical defense set on.
send_command('bind ^f9 gs c cycle MagicalDefenseMode') --Changes your magical defense set.
send_command('bind !f9 gs c cycle ResistDefenseMode') --Changes your resist defense set.
...
send_command('bind home gs c toggle Capacity') --Keeps capacity mantle on and uses capacity rings.
send_command('bind ^end gs c cycle treasuremode') --Toggles hitting htings with your treasure hunter set.
send_command('bind !end gs c cycle IdleMode') --Changes your idle mode options such as refresh.
send_command('bind end gs c toggle Kiting') --Keeps your kiting gear on..
