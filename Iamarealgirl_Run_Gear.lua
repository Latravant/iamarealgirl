...
function init_gear_sets()
	...
	-- Weaponskill sets
	sets.precast.WS = {main="Epeolatry", sub="Khonsu", ammo="Knobkierrie",
			head="Aya. Zucchetto +2", body="Ayanmo Corazza +2", hands="Meg. Gloves +2",
			legs="Aya. Cosciales +2", feet="Aya. Gambieras +2", neck="Fotia Gorget",
			waist="Fotia Belt", left_ear="Odr Earring",  right_ear="Ishvara Earring",
			left_ring="Niqmaddu Ring", right_ring="Karieyh Ring", 
			back={ name="Ogma's Cape", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%','Parrying rate+5%',}},}
    ...
    sets.idle = {main="Epeolatry", sub="Khonsu", ammo="Staunch Tathlum +1",
    head="Aya. Zucchetto +2", body={ name="Futhark Coat +1", augments={'Enhances "Elemental Sforzo" effect',}},
    hands="Aya. Manopolas +2", legs="Aya. Cosciales +2", feet="Aya. Gambieras +2",
    neck={ name="Loricate Torque +1", augments={'Path: A',}}, waist="Flume Belt +1", left_ear="Etiolation Earring",
    right_ear="Ethereal Earring", left_ring="Defending Ring", right_ring="Archon Ring", back="Solemnity Cape",}
