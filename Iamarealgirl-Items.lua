...
sets.TreasureHunter = {head="Wh. Rarab Cap +1",hands="Volte bracers",legs="Volte hose",waist="Chaac Belt"}
...
gear.herculean_nuke_head = {name="Herculean Helm", augments={'Mag. Acc.+20 "Mag.Atk.Bns."+20','Crit. hit damage +1%',}}
