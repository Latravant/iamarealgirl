...
function user_job_setup()
	...
	state.Weapons:options('Aeneas','Aeolian','Savage','ProcWeapons','Evisceration','Throwing','SwordThrowing','Bow', "TH")
...
function init_gear_sets()
	...
	sets.TreasureHunter = {ammo="perfect lucky egg",hands="Plunderer's Armlets +1",waist="Chaac Belt",legs="Volte Hose",feet="Skulk. Poulaines +1"}
	...
	sets.weapons.TH ={main="Sandung", sub="Taming Sari", ammo="perfect lucky egg"}
